 ...
 * @LastEditors: lxw
 * @LastEditTime: 2020-03-28 17:43:58
 -->
<template>
  <d2-container>
          ...
          <el-row :gutter="10">
            <el-col :span="6" :offset="8">
              ...
              >
                ...
                <div class="el-upload__tip" slot="tip">请保证视频格式正确，视频文件必须是英语命名,且一次大小不超过600M</div>
              </el-upload>
            </el-col>
          </el-row>
          <el-row :gutter="10">
  ...
  methods: {
    ...
    beforeUploadVideo (file) {
      ...
      if (/.*[\u4e00-\u9fa5]+.*$/.test(file.name)) {
        this.$message.error('App端无法播放带中文视频文件，请重新修改文件名后再上传')
        return false
      }
    },
    // 上传成功后显
